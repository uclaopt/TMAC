...
where :MATH:`Q` is a symmetric positive definite matrix. We solve the problem with TMAC by using backward-forward splitting.


Usage
---------
In the bin folder, the executable file :cpp:type:`tmac_bfs_l2_ball_qp` solves the above problem. The usage for tmac_prs_demo is:

.. code-block:: bash

    ./tmac_bfs_l2_ball [options]
...
.. code-block:: bash
   ...
   ./bin/tmac_bfs_l2_ball_qp -nthread 1 -problem_size 100 -epoch 200
