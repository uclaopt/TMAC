#ifndef AROCK_INCLUDE_SPLITTING_SCHEMES_H
#define AROCK_INCLUDE_SPLITTING_SCHEMES_H
...
struct BackwardForwardSplitting {
  Forward forward;
  Backward backward;
  Vector *x;
...
struct PeacemanRachfordSplitting {
  First op1;
  Second op2; 
  Vector *x;
  Vector y; // each new operator will have a copy of this guy
