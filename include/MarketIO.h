/**************************************************************************
 * Read file in matrix market form and save as a Eigen Sparse Matrix.
 *
...
inline bool getMarketHeader(const std::string& filename, int& sym, bool& iscomplex, bool& isvector)
{
  ...
  if(substr[4].compare("symmetric") == 0) sym = 1;
...
bool loadMarket(SparseMatrixType& mat, const std::string& filename)
{
  ...
  bool iscomplex = 0;
  bool isvector = 0;
  getMarketHeader(filename, sym, iscomplex, isvector);
  if(!input)
    return false;
